...
export default class ComponentDropdown extends Component {
  static propTypes = {
        ...
        onPress={this._onButtonPress.bind(this)}>
        {
          ...
          (
            <View style={styles.button}>
              ...
              {this.state.showDropdown === true ? <Image source={Images.ic_dropdodwnActive} style={{height: ratioHeight(16), width: ratioWidth(16)}} resizeMode='contain' />
              : <Image source={Images.ic_dropdodwn} style={{height: ratioHeight(16), width: ratioWidth(16)}} resizeMode='contain' />}
            </View>
          )
        }
      </TouchableOpacity>
