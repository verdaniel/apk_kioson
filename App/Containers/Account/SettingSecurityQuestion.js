...
class SettingSecurityQuestion extends Component {
    navigate (route) {
          ...
          return (
            <View style={{ flex: 1 }}>
              <View style={[{backgroundColor: Colors.white_two, marginVertical: ratioHeight(8)}]}>
                {this.renderMenu( 'Ganti Pertanyaan Keamanan', 0, 0.8, () => this.navigate('ChangeSecurityQuestion'))}
              </View>
              <View style={[{ backgroundColor: Colors.white_two, marginTop: ratioHeight(-6) }]}>
                {this.renderMenu('Lihat Pertanyaan Keamanan', 0, 0.8, () => this.navigate('SeeSecurityQuestion'))}  
...
export default connect(mapStateToProps, mapDispatchToProps)(SettingSecurityQuestion)
